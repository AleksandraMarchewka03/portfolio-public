  ...
  <section class="contact-section">
    ...
    <div class="contact-left">
      ...
      <div class="contact-info">
        ...
        <!-- Phone  assembled by JS -->
        <div class="contact-detail">
          <div class="detail-icon"><i class="fas fa-phone"></i></div>
          <div class="detail-text">
            <span>
              <span id="ph-label" style="font-weight:600;"></span>
              <span class="note-badge" data-translate="pleaseText">please text</span>
            </span>
          </div>
        </div>
        ...
        <div class="contact-detail">
          ...
          <div class="detail-text">
            ...
            <span style="font-size:0.8rem;opacity:0.65;" data-translate="contactRelocation">Open to relocation to Poland</span>
          </div>
        </div>
