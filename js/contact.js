...
/*  Obfuscated contact details 
   Stored as reversed char arrays: no plain address to prevent spam . */
(function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function getPopupText() {
    ...
    return lang === 'pl'
      ? '<strong>Londyn N4</strong><br>Otwarta na relokację do Polski'
      : '<strong>London N4</strong><br>Open to relocation to Poland';
  }
